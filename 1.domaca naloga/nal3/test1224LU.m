...
%Funkcija izracuna priblizek x za sistem A*x=b za A je c-63 z LU predpogojevanjem pri
%parametru alfa z metodami
%gmres(0),qmr,bicgstab, bicg, ter vnre njihove casovne
